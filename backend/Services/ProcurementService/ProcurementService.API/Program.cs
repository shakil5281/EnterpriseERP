...
using ProcurementService.Infrastructure;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ERP Procurement Service", Version = "v1" });
...
builder.Services.AddHealthChecks().AddDbContextCheck<ProcurementDbContext>("procurement-db");
