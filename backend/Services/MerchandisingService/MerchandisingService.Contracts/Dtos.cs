...
public sealed record BuyerDto(Guid Id, Guid CompanyId, string BuyerCode, string BuyerName, string? Country, string? ContactPerson, string? Email, string? Phone, string? Address, bool IsActive);
...
public sealed record StyleDto(Guid Id, Guid CompanyId, Guid BuyerId, Guid? SeasonId, Guid? GarmentItemId, string StyleNo, string? StyleName, string? Description, string? FabricDescription);
