...
namespace CuttingService.Infrastructure.Services;
...
public sealed class RedisCacheService : IRedisCacheService
{
    ...
    public RedisCacheService(IConfiguration configuration, ILogger<RedisCacheService> logger)
    {
        ...
        catch (RedisConnectionException ex) { logger.LogWarning(ex, "Redis is unavailable. CuttingService will run without distributed cache."); }
    }
