        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretKey = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    RecoveryCodesHash = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User2FAs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCompanyAccesses_UserId_IsDefaultCompany",
                table: "UserCompanyAccesses",
                columns: new[] { "UserId", "IsDefaultCompany" });
