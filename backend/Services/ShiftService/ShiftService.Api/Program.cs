...
using ShiftService.Api.Middleware;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ERP Shift Service", Version = "v1" });
...
app.UseSwagger();
app.UseSwaggerUI(o => o.SwaggerEndpoint("/swagger/v1/swagger.json", "Shift v1"));
app.UseCors("default");
