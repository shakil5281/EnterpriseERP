            ...
            cell: ({ row }) => (
                <div className="flex justify-end">
                    <Button 
                        ...
                        onClick={() => router.push(`/merchandising/accessories/button/${row.original.id}`)}
                    >
        ...
        <div className="flex flex-col gap-6 py-6 px-4 lg:px-10 bg-background min-h-screen">
            <div className="flex items-center justify-between gap-4 py-4 px-6 border-b bg-card rounded-xl shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold tracking-tight text-foreground">Button Booking Orders</h1>
                        <p className="text-xs text-muted-foreground font-medium">Select a program to manage button bookings</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button 
                        ...
                        className="text-xs h-9 px-3 gap-1.5 font-medium border-orange-200 hover:bg-orange-50 text-orange-600"
                    >
                ...
                <CardContent className="p-0">
                    ...
                    <div className="px-2 pb-2">
                        <DataTable
                            ...
                            data={filteredOrders}
                            isLoading={loading}
                            onRowClick={(row) => router.push(`/merchandising/accessories/button/${row.id}`)}
                            showTabs={false}
                            showActions={false}
                        />
                    </div>
