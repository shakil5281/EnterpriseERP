        ...
        <form onSubmit={submit}>
          <Card><CardHeader><CardTitle className="text-base">Receipt details</CardTitle></CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1"><Label>Receipt no</Label><Input value={receiptNo} onChange={(e) => setReceiptNo(e.target.value)} required /></div>
              ...
              <div className="space-y-1"><Label>Received from type</Label>
              ...
              <div className="space-y-1"><Label>Received from ID</Label><Input value={receivedFromId} onChange={(e) => setReceivedFromId(e.target.value)} /></div>
